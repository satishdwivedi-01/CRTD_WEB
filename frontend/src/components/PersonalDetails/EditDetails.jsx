      ...
      <div className="  ml-8 mt-4  w-[150vh]">
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            {/* Footer */}
            <div className="flex items-center justify-end gap-10 pt-6 border-t border-gray-200">
              <button
                type="submit"
              ...
              <p className="text-sm text-center mt-10 text-gray-500">© 2025 CRTD Technologies. All rights reserved.</p>
